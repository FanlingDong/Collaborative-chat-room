let fs,jwt,AsyncLock,InputError,AccessError;_4c0‍.x([["save",()=>save],["reset",()=>reset],["assertValidUserId",()=>assertValidUserId],["getUserIdFromAuthorization",()=>getUserIdFromAuthorization],["login",()=>login],["logout",()=>logout],["register",()=>register],["assertValidChannel",()=>assertValidChannel],["getChannels",()=>getChannels],["getChannel",()=>getChannel],["addChannel",()=>addChannel],["updateChannel",()=>updateChannel],["joinChannel",()=>joinChannel],["leaveChannel",()=>leaveChannel],["inviteChannel",()=>inviteChannel],["getUsers",()=>getUsers],["getUser",()=>getUser],["updateProfile",()=>updateProfile],["getMessages",()=>getMessages],["sendMessage",()=>sendMessage],["deleteMessage",()=>deleteMessage],["editMessage",()=>editMessage],["pinMessage",()=>pinMessage],["unpinMessage",()=>unpinMessage],["reactMessage",()=>reactMessage],["unreactMessage",()=>unreactMessage]]);_4c0‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_4c0‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_4c0‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_4c0‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);
  ...
  new Promise((resolve, reject) => {
    lock.acquire('saveData', () => {
      try {
       ...
       const save = () => update(users, channels, nextMessageId);
       const reset = () => {
  update({}, {}, 1);
  users = {};
  channels = {};
...
const getUserIdFromEmail = email => {
  ...
  reject(new InputError('Invalid email or password'));
       ...
       const logout = (authUserId) => userLock((resolve, reject) => {
...
const newChannelPayload = (name, creator, priv, description) => ({
  ...
  messages: [],
       ...
       const assertValidChannel = (channelId) => channelLock((resolve, reject) => {
...
// Returns the basic details of each channel
       const getChannels = () => channelLock((resolve, reject) => {
  resolve(Object.keys(channels).map(key => ({
    ...
    members: channels[key].members,
       ...
       const getChannel = (authUserId, channelId) => channelLock((resolve, reject) => {
  ...
  resolve(channelDetails);
       ...
       const addChannel = (authUserId, name, priv, description) => channelLock((resolve, reject) => {
  if (name === undefined) {
  ...
  resolve(channelId);
       ...
       const updateChannel = (authUserId, channelId, name, description) => channelLock((resolve, reject) => {
  assertChannelMember(authUserId, channelId);
  ...
  resolve();
       ...
       const joinChannel = (authUserId, channelId) => channelLock((resolve, reject) => {
  ...
  resolve();
       ...
       const leaveChannel = (authUserId, channelId) => channelLock((resolve, reject) => {
  assertChannelMember(authUserId, channelId);
...
// userId is an integer
       const inviteChannel = (authUserId, channelId, userId) => channelLock((resolve, reject) => {
  assertChannelMember(authUserId, channelId);
...
***************************************************************/
       ...
       const getUsers = () => userLock((resolve, reject) => {
  resolve(Object.keys(users).map(key => ({
    ...
    email: users[key].email,
       ...
       const getUser = (userId) => userLock((resolve, reject) => {
  ...
  resolve(userDetails);
       ...
       const updateProfile = (authUserId, email, password, name, bio, image) => userLock((resolve, reject) => {
...
// start is an int
       const getMessages = (authUserId, channelId, start) => channelLock((resolve, reject) => {
  ...
  resolve(channels[channelId].messages.slice(start, start + 25));
       ...
       const sendMessage = (authUserId, channelId, message, image) => channelLock((resolve, reject) => {
  ...
  resolve();
       ...
       const deleteMessage = (authUserId, channelId, messageId) => channelLock((resolve, reject) => {
  assertChannelMember(authUserId, channelId);
  ...
  resolve();
       ...
       const editMessage = (authUserId, channelId, messageId, newMessage, newImage) => channelLock((resolve, reject) => {
  ...
  resolve();
       ...
       const pinMessage = (authUserId, channelId, messageId) => channelLock((resolve, reject) => {
  assertChannelMember(authUserId, channelId);
  const messageIndex = findMsgIdxInChannel(channelId, messageId);
  ...
  resolve();
       ...
       const unpinMessage = (authUserId, channelId, messageId) => channelLock((resolve, reject) => {
  assertChannelMember(authUserId, channelId);
  const messageIndex = findMsgIdxInChannel(channelId, messageId);
  if (!channels[channelId].messages[messageIndex].pinned) {
  ...
  resolve();
       ...
       const reactMessage = (authUserId, channelId, messageId, react) => channelLock((resolve, reject) => {
  if (react === undefined) {
  ...
  resolve();
       ...
       const unreactMessage = (authUserId, channelId, messageId, react) => channelLock((resolve, reject) => {
  if (react === undefined) {
    return reject(new InputError('No react value provided'));
  }
  assertChannelMember(authUserId, channelId);
